...
DEPRECATED: Use core.infrastructure.config instead. This module redirects to the canonical location.
"""

# Re-export from canonical core.infrastructure.config location
