"""Textual TUI for pipeline configuration.
...
Usage:
    python -m pipelines new --tui           # Create new pipeline
    python -m pipelines edit ./config.yaml  # Edit existing pipeline
"""
...
# Lazy imports to avoid loading Textual unless TUI is actually used
__all__ = [
    "PipelineConfigApp",
    "run_create_wizard",
    "run_editor",
