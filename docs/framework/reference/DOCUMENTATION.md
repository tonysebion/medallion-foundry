...
**Tracing**
Set `BRONZE_TRACING=1` to emit OpenTelemetry spans (no-op if instrumentation absent). Useful around retries, chunk writes, and Silver chunk processing.
...
- **[Enhanced Features](../../usage/patterns/ENHANCED_FEATURES.md)** - Advanced features for production use
