            ...
            [
                {
                    "id": 1,
                    "effective_from": datetime(2025, 1, 1),
                    "effective_to": datetime(2025, 1, 10),
                },
                {
                    "id": 1,
                    "effective_from": datetime(2025, 1, 10),
                    "effective_to": datetime(2025, 1, 20),
                },
                {
                    "id": 1,
                    "effective_from": datetime(2025, 1, 20),
                    "effective_to": None,
                },
            ]
        )
    ...
    def test_gap_in_dates_fail(self):
        ...
        df = pd.DataFrame(
            [
                ...
                {
                    "id": 1,
                    "effective_from": datetime(2025, 1, 15),
                    "effective_to": None,
                },  # Gap!
            ]
        )
...
class TestSCD2HistoryPreserved:
    ...
    def test_expected_versions(self):
        ...
        result = SCD2Assertions.assert_history_preserved(
            df, keys=["id"], expected_counts={1: 3, 2: 2}
        )
        assert result.passed is True
